...
public class Requirement6 {
	...
	public Requirement6(String name, String website, String mobile, String founder, Integer numberOfDept, String location,
			Date createdDate) {
		super();
		this.name = name;
	...
	static Map<String,Integer> calculateLocationCount(List<Requirement6> list)
	{
		Map<String, Integer> map=new TreeMap<>();
		for(Requirement6 requirement:list)
		{
			String key = requirement.getLocation();
